...
public class NarrowcastTest {
    ...
    @Test
    public void testDeserializeOperatorDemographicFilter() throws IOException {
    ...
    @Test
    public void testRecipientDeserializeAudience() throws IOException {
        ObjectMapper objectMapper = ModelObjectMapper.createNewObjectMapper();
    ...
    @Test
    public void testRecipientDeserializeOperator() throws IOException {
        ObjectMapper objectMapper = ModelObjectMapper.createNewObjectMapper();
        Recipient recipient = objectMapper.readValue(
                "{\"type\":\"operator\","
