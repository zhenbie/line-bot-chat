 ...
 * under the License.
 */
package com.linecorp.bot.spring.boot.infra.line.api.v2;
...
import com.linecorp.bot.spring.boot.common.constant.CommonConstant;
import com.linecorp.bot.spring.boot.infra.http.Client;
...
import com.linecorp.bot.spring.boot.infra.line.api.v2.response.Verify;
...
public class LineAPIService {
    ...
    private <R> R getClient(final Function<LineAPI, Call<R>> function) {
        return Client.getClient(CommonConstant.LINE_API_BASE_URL, LineAPI.class, function);
    }
